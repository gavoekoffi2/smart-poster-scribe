...
const domainConfig = [
  ...
  { id: "church", name: "Église", icon: Church },
  { id: "restaurant", name: "Restaurant", icon: UtensilsCrossed },
  { id: "formation", name: "Formation", icon: GraduationCap },
  { id: "ecommerce", name: "E-commerce", icon: Store },
  { id: "event", name: "Événement", icon: Calendar },
  { id: "service", name: "Service", icon: Briefcase },
  { id: "fashion", name: "Mode", icon: Shirt },
  { id: "realestate", name: "Immobilier", icon: Building },
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
              ...
              <button
                ...
                className={`
                  ...
                  ${isActive
                    ...
                    : "bg-card/60 border border-border/40 text-muted-foreground hover:border-primary/40 hover:text-foreground"
                  }
                `}
              >
        ...
        {loading ? (
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {Array.from({ length: 8 }).map((_, i) => (
              <div
                key={i}
                className="aspect-[3/4] rounded-2xl bg-card/40 border border-border/40 animate-pulse"
              />
            ))}
          </div>
        ) : templates.length === 0 ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {templates.map((template, index) => (
              <div
                key={template.id}
                className="group relative rounded-2xl overflow-hidden cursor-pointer aspect-[3/4] bg-card/40 border border-border/40 hover:border-primary/40 transition-all duration-300"
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-background/60 backdrop-blur-sm">
                  <Button
                    ...
                    className="glow-orange bg-gradient-to-r from-primary to-accent rounded-full px-6"
                  >
        ...
        <div className="text-center mt-12">
          <Button
            ...
            className="glow-orange bg-gradient-to-r from-primary to-accent rounded-full px-8 py-6 text-lg"
          >
            Créer mon affiche
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-1/2">
                <img
                  ...
                  alt={selectedTemplate.description || "Template"}
              ...
              <div className="md:w-1/2 p-8 flex flex-col justify-between">
                ...
                <div className="space-y-3">
                  <Button
                    ...
                    className="w-full glow-orange bg-gradient-to-r from-primary to-accent rounded-full py-6"
                  >
                    <Copy className="w-4 h-4 mr-2" />
                    Cloner ce design
                  </Button>
