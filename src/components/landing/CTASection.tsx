        ...
        <div className="relative rounded-[40px] bg-gradient-to-br from-card/80 to-card/40 border border-primary/20 p-12 md:p-20 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              <span className="text-foreground">Prêt à créer votre</span>
              <br />
              <span className="gradient-text">première affiche ?</span>
            </h2>

            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-12">
              Uploadez une référence ou choisissez un template. L'IA fait le reste en quelques secondes.
            </p>
